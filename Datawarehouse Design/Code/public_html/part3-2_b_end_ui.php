...
$table_return.="<tr><td>USER ID</td><td>p VALUE</td><td>CLASSIFCATION</td></tr>";
...
$temp1=$p<0.01?'classfied as '.$name:'NOT classfied as '.$name;
$table_return.="<tr><td>test".($k+1)."</td><td>".$p."</td><td>".$temp1."</td></tr>";
